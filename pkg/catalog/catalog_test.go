...
func TestCatalog_ListEntries(t *testing.T) {
	...
	gravelerData := []*graveler.ValueRecord{
		{Key: graveler.Key("file1"), Value: MustEntryToValue(&Entry{Address: "file1", LastModified: timestamppb.New(now), Size: 1, ETag: "01", Metadata: NewMetadataFromMap(nil)})},
		{Key: graveler.Key("file2"), Value: MustEntryToValue(&Entry{Address: "file2", LastModified: timestamppb.New(now), Size: 2, ETag: "02", Metadata: NewMetadataFromMap(nil)})},
		{Key: graveler.Key("file3"), Value: MustEntryToValue(&Entry{Address: "file3", LastModified: timestamppb.New(now), Size: 3, ETag: "03", Metadata: NewMetadataFromMap(nil)})},
		{Key: graveler.Key("h/file1"), Value: MustEntryToValue(&Entry{Address: "h/file1", LastModified: timestamppb.New(now), Size: 1, ETag: "01", Metadata: NewMetadataFromMap(nil)})},
		{Key: graveler.Key("h/file2"), Value: MustEntryToValue(&Entry{Address: "h/file2", LastModified: timestamppb.New(now), Size: 2, ETag: "02", Metadata: NewMetadataFromMap(nil)})},
	}
	type args struct {
		prefix    string
		after     string
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{limit: -1},
			want: []*DBEntry{
				{Path: "file1", PhysicalAddress: "file1", CreationDate: now, Size: 1, Checksum: "01", Metadata: map[string]string{"content-type": "application/octet-stream"}},
				{Path: "file2", PhysicalAddress: "file2", CreationDate: now, Size: 2, Checksum: "02", Metadata: map[string]string{"content-type": "application/octet-stream"}},
				{Path: "file3", PhysicalAddress: "file3", CreationDate: now, Size: 3, Checksum: "03", Metadata: map[string]string{"content-type": "application/octet-stream"}},
				{Path: "h/file1", PhysicalAddress: "h/file1", CreationDate: now, Size: 1, Checksum: "01", Metadata: map[string]string{"content-type": "application/octet-stream"}},
				{Path: "h/file2", PhysicalAddress: "h/file2", CreationDate: now, Size: 2, Checksum: "02", Metadata: map[string]string{"content-type": "application/octet-stream"}},
			},
			wantHasMore: false,
			wantErr:     false,
		},
